	...
	return (
		<div className="w-full max-w-5xl flex flex-col items-center gap-6 sm:gap-8">
			...
			<p className="text-xl md:text-2xl text-center max-w-2xl px-6">
				Create a professional resume in minutes with our easy-to-use builder. No
				sign-up required, free to use, and export-ready.
			</p>
			<div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
				<a
					...
					onClick={(e) => {
						e.preventDefault();
						const buildLink = document.querySelector('[data-section="build"]');
						if (buildLink) {
							buildLink.click();
